...
router
  .route('/admin')
  .post(auth('createUser'), validate(userValidation.createAdminUser), userController.createAdminUser)
...
router.route('/:id/active').patch(auth('updateUser'), validate(userValidation.activeUser), userController.activeUser);
